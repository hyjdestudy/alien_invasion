...
def check_play_button(
    ...
    # 用not stats.game_active保证只有在游戏未开始时，单击play有效，游戏中单击play无效
...
def check_bullet_alien_collision(
    ...
    if collisions:
        """
        print "字典长度："+str(len(collisions))
        print "字典key的长度："+str(len(collisions.keys()))
        for key in collisions.keys():
            print "key:"
            print key
            print "字典的值的长度："+str(len(collisions.values()))
